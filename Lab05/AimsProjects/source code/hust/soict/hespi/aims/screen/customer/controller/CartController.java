...
import hust.soict.hespi.aims.exception.PlayerException; // Import PlayerException
...
public class CartController {
    ...
    void btnViewStorePressed(ActionEvent event) {
        try {
            ...
            loader.setControllerFactory(c -> new hust.soict.hespi.aims.screen.customer.controller.ViewStoreController(store, cart));
